...
def tela_usuario(cod_user):  
    ...
    app_ = Label(frameDireita, text="Relatórios", width=50, compound=LEFT, padx=5, pady=10, font=('Verdana 17'), bg=co2, fg=co1)
    ...
    def tela_solicitacao():
        def add_solicitacao():
            ...
            list_data = [data_user, data_name,  data_categories, data_deposits, data_amount, data_value]
            ...
            for i in list_data:
                ...
                create_solicitacao(data_user, data_name, data_categories, data_deposits, data_amount, data_value)
        ...
        app_ = Label(frameDireita, text="Solicitar Compras", width=50, compound=LEFT, padx=5, pady=10, font=('Verdana 17'), bg=co2, fg=co1)
        app_.grid(row=0, column=0, columnspan=4,sticky=NSEW)
        #Texto cod usuario
        ...
        l_categories.grid(row=4, column=0, padx=5,pady=10, sticky=NSEW)
        # Input da categoria
        i_categories = Entry(frameDireita, width=25,justify='left', relief='solid')
        i_categories.grid(row=4, column=1, padx=5,pady=10, sticky=NSEW)
        
        #Texto Depositos
        l_deposits = Label(frameDireita, text="Deposito", font=('Ivy 12'), bg=co3, fg=co5)
        l_deposits.grid(row=5, column=0, padx=5,pady=10, sticky=NSEW)
        # Input do Deposito
        i_deposits = Entry(frameDireita, width=25,justify='left', relief='solid')
        i_deposits.grid(row=5, column=1, padx=5,pady=10, sticky=NSEW)

        # Texto Quantidade
        l_amount = Label(frameDireita, text="Quantidade", font=('Ivy 12'), bg=co3, fg=co5)
        l_amount.grid(row=6, column=0, padx=5,pady=10, sticky=NSEW)
        # Input da quantidade
        i_amount = Entry(frameDireita, width=25,justify='left', relief='solid')
        i_amount.grid(row=6, column=1, padx=5,pady=10, sticky=NSEW)
        # Texto valor
        l_value = Label(frameDireita, text="Valor", font=('Ivy 12'), bg=co3, fg=co5)
        l_value.grid(row=7, column=0, padx=5,pady=10, sticky=NSEW)
        # Input do valor
        i_value = Entry(frameDireita, width=25,justify='left', relief='solid')
        i_value.grid(row=7, column=1, padx=5,pady=10, sticky=NSEW)

        #btn salvar
        b_solicitacao = Button(frameDireita, command=add_solicitacao, compound=LEFT, width=25, anchor=NW, text=" Salvar", bg=co5, fg=co2, font=('Ivy 11'), overrelief=RIDGE, relief=GROOVE)
        b_solicitacao.grid(row=8, column=1, sticky=NSEW, pady=5)   
...
#Menu lateral
    ...
    b_car = Button(frameEsquerda,command=lambda:controlMenu('Relatórios'), compound=LEFT, anchor=NW, text="Relatórios", bg=co5, fg=co2, font=('Ivy 11'), overrelief=RIDGE, relief=GROOVE)
    b_car.grid(row=0, column=0, sticky=NSEW, padx=5,pady=6)
    b_car = Button(frameEsquerda,command=lambda:controlMenuSolicitacao('Solicitações'), compound=LEFT, anchor=NW, text="Solicitar Compra", bg=co5, fg=co2, font=('Ivy 11'), overrelief=RIDGE, relief=GROOVE)
